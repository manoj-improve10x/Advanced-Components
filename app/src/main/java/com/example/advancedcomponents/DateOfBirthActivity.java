...
public class DateOfBirthActivity extends AppCompatActivity {
    ...
    public void setupDate() {
        ...
        ArrayAdapter<Integer> integerArrayAdapter = new ArrayAdapter<Integer>(this, android.R.layout.simple_list_item_1, datesList);
        dateSp.setAdapter(integerArrayAdapter);
    ...
    public void setupMonth() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, R.layout.drop_down_xml, monthsList);
